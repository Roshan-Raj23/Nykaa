...
for(let i = 0;i< 10;i++){
    ...
    '<a href="pages/hair.html" class="aremove"><div class="productcards">\
        <div class="features">\
            <div class="featured">' + featured + '</div>\
            <div class="bestseller">' + best + '</div>\
        </div>\
        <img class="productimg" src="assets/images/hair/h' + (i+1) + '.avif">\
...
for(let i = 0 ;i< 6;i++){
    ...
    '<div class="carousel-item">\
        <img src="assets/images/slideshow/h' + (i+2) + '.avif" class="d-block w-100 slider" alt="..." />\
    </div>';
}